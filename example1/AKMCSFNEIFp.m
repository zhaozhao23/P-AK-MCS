...
while (1)
    ...
    muf=sqrt(2/pi)*sqrt(s2).*exp(-(mu./sqrt(s2)).^2/2)+mu.*(2*normcdf(mu./sqrt(s2))-1);
    sigf=mu.^2+s2-muf.^2;
    index1=2*sigf>=muf;
    index2=2*sigf<muf;
    FNEIF=zeros(N_sample,1);
    FNEIF(index1)=2*sigf(index1).*(normcdf((2*sigf(index1)-mu(index1))./sqrt(s2(index1)))-normcdf((-2*sigf(index1)-mu(index1))./sqrt(s2(index1))))+...
        muf(index1).*(normcdf((muf(index1)-mu(index1))./sqrt(s2(index1)))-normcdf((-muf(index1)-mu(index1))./sqrt(s2(index1)))-normcdf((2*sigf(index1)-mu(index1))./sqrt(s2(index1)))+normcdf((-2*sigf(index1)-mu(index1))./sqrt(s2(index1)))-1)+sqrt(s2(index1)).*(normpdf((muf(index1)+mu(index1))./sqrt(s2(index1)))+normpdf((muf(index1)-mu(index1))./sqrt(s2(index1))))+mu(index1).*(normcdf((muf(index1)+mu(index1))./sqrt(s2(index1)))-normcdf((muf(index1)-mu(index1))./sqrt(s2(index1))));
    FNEIF(index2)=2*sigf(index2).*(normcdf((2*sigf(index2)-mu(index2))./sqrt(s2(index2)))-normcdf((-2*sigf(index2)-mu(index2))./sqrt(s2(index2))))-...
        muf(index2)+sqrt(s2(index2)).*(normpdf((2*sigf(index2)+mu(index2))./sqrt(s2(index2)))+normpdf((2*sigf(index2)-mu(index2))./sqrt(s2(index2))))+mu(index2).*(normcdf((2*sigf(index2)+mu(index2))./sqrt(s2(index2)))-normcdf((2*sigf(index2)-mu(index2))./sqrt(s2(index2))));
    [a,b]=max(FNEIF);
    if a<=0;break;end
    x_new=x(b,:);
    for j=1:p-1
